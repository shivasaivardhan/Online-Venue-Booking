		...
		<div id="mynav" class="container">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item "><a class="nav-link" style="color: white;"
					href="/allvenues">VENUES <span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item active"><a class="nav-link"
					style="color: white;" href="/bookvenue">BOOK VENUE</a></li>
				<li class="nav-item "><a class="nav-link" style="color: white;"
					href="/userbookings">MY BOOKINGS</a></li>
				<li class="nav-item "><a class="nav-link" style="color: white;"
					href="/userfeedback">FEEDBACK</a></li>
				<li class="nav-item "><a class="nav-link" style="color: white;"
...
<br>
	...
	<div class="form-container">
		...
		<form action="/conformvenue" method="post"
			modelAttribute="selectvenue">
			<div class="form-group">
				<label for="venueName">Venue Name:</label> <input type="text"
					class="form-control" value="${vname}" readonly="true"
					id="venueName" name="venuename" required="required">
			</div>
			<div class="form-group">
